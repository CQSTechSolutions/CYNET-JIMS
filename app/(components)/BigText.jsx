			...
			>
				{bigTextCnt.map((c, index) => (
					<div key={index} className={"text-white flex flex-col gap-1"}>
						<p className={"mt-5 text-center font-poppins tracking-[0.5vw]"}>{c.small_Letter}</p>
						<h2
							className={
								"text-[14vw] bg-gradient-to-b from-white to-white/40 text-transparent bg-clip-text -mt-16 font-monot"
							}
						>
							{c.big_Letter}
						</h2>
