...
const BigText = () => {
	...
	return (
		<div className={"h-full w-full flex flex-col items-center justify-center px-2 md:px-4"}>
			<div
				id={"big-text-wrapper"}
			...
			>
				{bigTextCnt.map((c, index) => (
					<div key={index} className={"text-white flex flex-col gap-1"}>
						<p className={"mt-3 md:mt-5 text-center font-poppins tracking-[0.2vw] md:tracking-[0.5vw] text-[10px] md:text-base whitespace-nowrap"}>
							{c.small_Letter}
						</p>
						<h2
							className={
			...
			<Image
				...
				width={120}
				height={120}
				className={"rounded-full mt-4 md:mt-6 w-32 h-32 md:w-[120px] md:h-[120px]"}
			/>
		</div>
	);
};
