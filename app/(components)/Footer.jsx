                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            <Link href="https://www.instagram.com" target="_blank" className="hover:text-pink-500 transition-colors">
                            ...
                            <Link href="https://www.linkedin.com" target="_blank" className="hover:text-blue-500 transition-colors">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 font-poppins">
                            ...
                            <li>
                                <Link href="/register_for_events" className="text-gray-400 hover:text-white transition-colors">
                                    Register
                                </Link>
                            </li>
                            <li>
