      ...
      <div className="relative z-10">
        ...
        <div className="py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            <h1 className="text-4xl text-center text-white mb-12 font-monot">Contact Us</h1>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Contact Form */}
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
                <div className="px-6 py-8">
                  <h2 className="text-3xl text-center text-green-700 mb-8 font-monot">Send Us a Message</h2>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
                <div className="px-6 py-8">
                  <h2 className="text-3xl text-center text-green-700 mb-8 font-monot">Our Location</h2>
                  <div className="mb-6">
                    <div className="flex items-center mb-4">
                      <FaMapMarkerAlt className="text-2xl text-green-600 mr-3 flex-shrink-0" />
                      <p className="text-gray-700">
                        JIMS VK, MOR Pocket, Sector-C, Vasant Kunj, New Delhi, Delhi 110070
                      </p>
                    </div>
                  </div>
