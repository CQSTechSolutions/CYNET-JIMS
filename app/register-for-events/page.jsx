...
const Page = () => {
    ...
    const gamexcite = [
        { id: "Assassin-creed-shadow", name: "Assassin's Creed Shadows", price: 50 },
        { id: "bgmi-tournament", name: "BGMI Tournament", price: 200 },
        { id: "takken-7", name: "Tekken 7", price: 50 },
        { id: "smash-kart", name: "Smash Karts", price: 30 },
        { id: "stumble-guys", name: "Stumble Guys", price: 30 },
        { id: "valorant-tournament", name: "Valorant Tournament", price: 250 },
        { id: "squid-games-robolox", name: "Squid Games (Roblox)", price: 50 },
        { id: "mortal-kombat-11", name: "Mortal kombat 11", price: 100 },
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        // Only validate payment screenshot if there are paid events
        if (formData.totalPayable > 0 && !formData.payment_ss) {
            toast.error('Please upload your payment screenshot before submitting'); // Using toast for error message
        ...
        try {
            ...
            if (result.success) {
                toast.success(result.message); // Using toast for success message
                                            ...
                                            onSuccess={(result, widget) => {
                                                try {
                                                    if (result.event === "success") {
                                                        ...
                                                        toast.success('Payment screenshot uploaded successfully!'); // Using toast for success message
                                                    }
                                                } catch (error) {
                                                    console.error('Upload error:', error);
                                                    toast.error('Failed to upload payment screenshot. Please try again.'); // Using toast for error message
                                                }
                                            }}
                                            onError={(error) => {
                                                console.error('Upload error:', error);
