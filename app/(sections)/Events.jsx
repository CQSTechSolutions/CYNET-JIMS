...
const Events = () => {
    ...
    return (
        <div className='w-screen min-h-screen font-poppins flex gap-8 flex-col items-center justify-center bg-gradient-to-b from-blue-500 to-black py-20'>
            <h2 className='text-4xl md:text-6xl font-monot text-white mt-16'>Events</h2>
