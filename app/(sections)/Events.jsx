    ...
    <div className='w-screen min-h-auto h-screen font-poppins flex gap-18 flex-col items-center justify-center bg-gradient-to-b from-blue-500 to-black'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 p-8">
        {eventList.map((event, index) => (
          <div 
            key={index}
            className="cursor-pointer bg-gray-800 p-8 rounded-lg shadow-lg flex justify-center items-center text-5xl transition-transform transform hover:scale-105"
          >
