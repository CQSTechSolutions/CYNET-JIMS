...
const Events = () => {
  ...
  return (
    <div className="w-screen min-h-screen relative">
      ...
      <div className="w-full min-h-screen font-poppins flex gap-8 flex-col items-center justify-center py-20 relative z-2">
        <h2 className="text-4xl md:text-6xl font-monot text-white mt-16">
          Events
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 p-4 md:p-8 max-w-7xl mx-auto">
          {eventList.slice(0, 4).map((event, index) => (
            <div key={index} className="hexagon-container group">
              <div className="hexagon bg-gray-800/80 backdrop-blur-sm hover:bg-gray-700/90 transition-all duration-300 border border-green-500">
                <div className="hexagon-content">
                  <h3 className="text-white md:text-2xl capitalize text-center font-poppins font-bold text-xl group-hover:text-green-400 transition-colors">
                    {event.replace(/-/g, " ")}
                  </h3>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-4 md:p-8 max-w-7xl mx-auto">
          {eventList.slice(4).map((event, index) => (
            <div key={index + 4} className="hexagon-container group">
              <div className="hexagon bg-gray-800/80 backdrop-blur-sm hover:bg-gray-700/90 transition-all duration-300 border border-green-500">
                <div className="hexagon-content">
