    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-[#210000] to-[#830101] text-white py-20 overflow-hidden">
            <div className="container mx-auto px-4 relative" ref={ref}>
                ...
                <div
                    className="absolute top-0 left-0 w-full h-full bg-gradient-radial from-purple-500/10 via-blue-500/10 to-transparent blur-2xl -z-10"/>
                                        ...
                                        <ul className="space-y-3">
                                            {round.rules.map((rule, ruleIndex) => (
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        className="group-hover:text-white transition-colors duration-300">{rule}</span>
                                                </li>
                                            ))}
                                        </ul>
                                    </motion.div>
